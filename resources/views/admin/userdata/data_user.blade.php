          ...
          <div class="col-sm-6">
            ...
            <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                    <a href="{{ url('admin/userdata/create') }}" class="btn btn-md btn-primary mb-3">TAMBAH USER</a>
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                        action="{{ url('admin/userdata/destroy', $user->id) }}" method="POST">
                                        <a href="{{ url('admin/userdata/show', $user->id) }}"
                                            class="btn btn-sm btn-warning">SHOW</a>
                                        <a href="{{ url('admin/userdata/edit', $user->id) }}"
