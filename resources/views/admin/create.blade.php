...
<head>
    ...
    <title>Admin | Tambah data Pegawai</title>
                        ...
                        <div class="card-body">
                            <form action="{{ url('admin/store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" rows="5" placeholder="Masukkan Alamat Pegawai">{{ old('alamat') }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Masukkan Jenis Tempat Lahir">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="date" class="form-control @error('tgl_masuk') is-invalid @enderror" name="tgl_masuk" value="{{ old('tgl_masuk') }}" placeholder="Masukkan tgl_masuk">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('jobdesc') is-invalid @enderror" name="jobdesc" rows="5" placeholder="Masukkan Alamat Pegawai">{{ old('jobdesc') }}</textarea>
